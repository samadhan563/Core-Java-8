...
public class Student 
{
	...
	public Student(int studentId, String course, LocalDate birthDate) 
	{
		this.studentId = studentId;
		this.course = course;
		this.birthDate = birthDate;
	...
	public boolean equals(Object o)
	{
		...
		if(o instanceof Student)
		{
			...
			return studentId==student.studentId && course.equals(student.course)
	...
	public int hashCode()
	{
		...
		return studentId+course.hashCode()+birthDate.hashCode();	
	}
